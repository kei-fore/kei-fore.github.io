...
target.insertAdjacentHTML("afterend","<link rel='stylesheet' type='text/css' href='https://kei-fore.github.io/BacknSkipCSS.css'><input type='button' value='&#xf048; 15' id='goback' onclick='goback();'/><input type='button' value='&#xf051; 15' id='goforward' onclick='goforward();'/><input type='button' value='&#xf04a; 0.1' id='speedup' onclick='speedown();'/><input type='button' value='&#xf04e; 0.1' id='speedup' onclick='speedup();'/><input type='button' value='&#xf0e2; Reset' id='resetspeed' onclick='resetspeed();'/>");
